...
/**The channels command is the base "/c" command
 * 
 * @author Alex
 *
 */
public class CommandChannels extends BaseCommand
{
  CommandHandler handler;
  
  public CommandChannels(String command_path, CommandHandler handler)
  {
    super(command_path);
    this.permission = "channels.help";
  ...
  public boolean run(CommandSender sender, String[] args)
  {
    ...
    sender.sendMessage(ChatColor.GRAY + "<<< <<< <<< " + ChatColor.YELLOW + "Channels Command Usage" + ChatColor.GRAY + " >>> >>> >>>");
